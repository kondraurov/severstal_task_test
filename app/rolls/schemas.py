...
class SchemasRoll(BaseModel):
    ...
    date_added: Optional[datetime] = Field(None, description="Дата добавления")
    date_removed: Optional[datetime] = Field(None, description="Дата удаления")

    @field_validator("date_removed")
    @classmethod
    def validate_dates(cls, date_removed, values):
        date_added = values.get("date_added")
